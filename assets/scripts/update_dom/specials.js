// axios.get('/api/specialsBar').then(response => {
    ...
    const barSpecials = [
        {day: 'Monday', special: '4.00 Well Drinks'},
        {day: 'Tuesday', special: '5.00 U-Call It (Excludes frozen, blended, and specialty drinks)'},
        {day: 'Wednesday', special: '5.00 Regular Frozen or Rocks Margaritas'},
        {day: 'Thursday', special: '3.00 Domestic / 5.00 Craft Drafts'},
        {day: 'Friday', special: '10.00 Mextinis'},
        {day: 'Saturday', special: '11.00 Domestic / 18.00 Craft Draft Pitchers'},
        {day: 'Sunday', special: '6.00 Bloody Marys'}
    ];
